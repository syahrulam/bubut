...
<body>
      ...
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="" class="btn-get-started" data-bs-toggle="modal" data-bs-target="#exampleModal">Pesan</a>
            <a href="" class="btn-get-started" style="margin-left: 10px;" data-bs-toggle="modal" data-bs-target="#reservasiModal">Reservasi</a>
            <a href="https://youtu.be/QQ7Fv6MvaQA" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
          </div>
        </div>
            ...
            <div class="modal-body">
              <form action="/pemesanan" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="exampleFormControlInput1" name="nama" placeholder="Nama Lengkap" required>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label">No WA</label>
                  <input type="text" class="form-control" id="exampleFormControlInput1" name="no_wa" placeholder="No WhatsApp" required>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label">Alamat</label>
                  <input type="text" class="form-control" id="exampleFormControlInput1" name="alamat" placeholder="Alamat" required>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label">Pesanan</label>
                  <select class="form-select" name="pesanan" aria-label="Default select example" required>
                ...
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label">Estimasi</label>
                  <input type="date" class="form-control" id="exampleFormControlInput1" name="estimasi" placeholder="Estimasi" required>
                </div>
                <div class="mb-3">
    ...
    <!-- Reservasi Modal -->
      <div class="modal fade" id="reservasiModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">Form Reservasi</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <form action="/store-reservasi" method="POST">
                @csrf
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label">Nama</label>
                  <input type="text" class="form-control" id="exampleFormControlInput1" name="nama" placeholder="Nama Lengkap" required>
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" name="jasa" aria-label="Default select example" required>
                    ...
                    <option value="{{$list->nama_jasa}}">{{$list->nama_jasa}}</option>
                    @endforeach
                  </select>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Keterangan" name="keterangan" required></textarea>
                </div>
            </div>
            <div class="modal-footer">
      ...
      <div class="container position-relative">
        <div class="row gy-4 mt-5">
          ...
          <div class="col-xl-3 col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              <div class="icon"><i class="bi bi-house-fill"></i></div>
              <h4 class="title"><a href="" class="stretched-link">Jasa Las</a></h4>
            </div>
          </div>
          <!--End Icon Box -->
  ...
  <main id="main">
    ...
    <div class="container">
      ...
      <div class="row" style="padding-left: 5%; padding-bottom: 10%;">  
        
      @foreach($produk as $produk)
        
      <div class="col">
      <div class="card shadow p-3 mb-5 bg-body-tertiary rounded" style="width: 18rem; ">
        <img src="{{asset('storage/image/produk/'.$produk->image)}}" class="card-img-top" alt="Produk" style="width: 100%; height: 80%;">
        <div class="card-body">
          <h5 class="card-title">{{$produk->namabarang}}</h5>
    ...
    <div class="container">
      ...
      <div class="row" style="padding-left: 5%">  
        ...
        <div class="col">
        <div class="card shadow p-3 mb-5 bg-body-tertiary rounded" style="width: 18rem; ">
          <img src="{{asset('storage/image/jasa/'.$jasa->image)}}" class="card-img-top" alt="Produk" style="width: 100%; height: 80%;">
          <div class="card-body">
